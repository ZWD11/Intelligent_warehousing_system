<template>
    <div>
        ...
        <div calss="pagination-size" style="right: 36%; overflow: hidden; position: fixed; margin-top: 5px;">
            <el-pagination
    ...
    export default {
        ...
        data() {
            ...
            let checkPhoneDuplicate = (rule, value, callback) => {
                ...
                this.$axios.get(this.$httpUrl + "/user/findByPhone?phone="+this.form.phone).then(res => res.data).then(res => {
                    console.log(phone);
                    if(res.code != 200){
                        callback();
                    }else{
